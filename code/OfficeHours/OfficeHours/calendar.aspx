...
<body>
    ...
    <div>
        ...
        <asp:Table 
            ...
            ID="Table1" runat="server" style="z-index: 1; left: 388px; top: 123px; position: absolute; height: 220px; width: 443px; right: 1496px;">
        </asp:Table>
        <asp:Label ID="Label5" runat="server" style="z-index: 1; left: 396px; top: 1px; position: absolute" Text="Office Hours Scheduling System" Font-Bold="True" Font-Size="XX-Large"></asp:Label>
        <p>
        <asp:Label ID="Label3" runat="server" style="z-index: 1; left: 232px; top: 376px; position: absolute; bottom: 199px;" Text="Choose Time:"></asp:Label>
            <asp:Label ID="Label6" runat="server" style="z-index: 1; left: 147px; top: 94px; position: absolute; width: 357px; height: 27px;" inputtype="text" placeholder="search" ></asp:Label>
        ...
        <asp:Label ID="Label11" runat="server" font-bold="True" font-size="14pt" style="z-index: 1; left: 894px; top: 133px; position: absolute; bottom: 829px" Text="Help:" ForeColor="#990000"></asp:Label>
        <asp:Label ID="Label12" runat="server" style="z-index: 1; left: 843px; top: 162px; position: absolute; width: 438px; bottom: 805px" Text="1. Select a date on the calendar"></asp:Label>
        <asp:Label ID="Label13" runat="server" style="z-index: 1; left: 843px; top: 190px; position: absolute; bottom: 779px; width: 438px" Text="2. Select a department"></asp:Label>
        <asp:Label ID="Label14" runat="server" style="z-index: 1; left: 844px; top: 248px; position: absolute; right: 1280px" Text="4. Select a time"></asp:Label>
        <asp:Label ID="Label16" runat="server" style="z-index: 1; left: 842px; top: 300px; position: absolute; width: 204px; height: 26px;" Text="6. Click 'Submit Request' button"></asp:Label>
        <asp:Label ID="Label15" runat="server" style="z-index: 1; left: 843px; top: 274px; position: absolute; width: 351px" Text="5. Modify message (optional)"></asp:Label>
        <p>
