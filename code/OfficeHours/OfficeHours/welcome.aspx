...
<body>
    ...
    <div style="width: auto; margin: 0 10%;">
        ...
        <asp:Button ID="Button4" runat="server" OnClientClick="window.location.href='/Registration.aspx'; return false;" style="z-index: 1; left: 99px; top: 155px; position: absolute; width: 145px;" Text="Create Account" />
    </div>
